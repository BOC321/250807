    ...
    try {
      ...
      const formattedCategories = categoriesData.map(category => ({
        ...
        questions: category.questions.map(question => {
          ...
          try {
            // Handle choice_scores - could be a string, array, or PostgreSQL array format
            if (question.choice_scores) {
              if (typeof question.choice_scores === 'string') {
                // Check if it's a PostgreSQL array format like '{0,1,2}'
          ...
          // Ensure choiceScores has the same length as choices
                    ...
                    <div style={{ display: 'flex', gap: '1rem', marginBottom: '0.5rem' }}>
                      <div style={{ flex: 1 }}>
                        ...
                        <input
                          ...
                          onChange={(e) => updateQuestion(categoryIndex, questionIndex, 'maxScore', parseInt(e.target.value))}
                          style={{ width: '100%', padding: '0.5rem' }}
                        />
                      </div>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <input
                          ...
                          onChange={(e) => updateQuestion(categoryIndex, questionIndex, 'weight', parseInt(e.target.value))}
                          style={{ width: '100%', padding: '0.5rem' }}
                        />
                      </div>
                    </div>
                      ...
                      <div style={{ flex: 1 }}>
                        <label>
                          <input
                            ...
                            onChange={(e) => updateQuestion(categoryIndex, questionIndex, 'required', e.target.checked)}
                      ...
                      <div style={{ flex: 1 }}>
                        <label>
                          <input
                            ...
                            onChange={(e) => updateQuestion(categoryIndex, questionIndex, 'scorable', e.target.checked)}
                            style={{ marginRight: '0.5rem' }}
                          />
                          Scorable
                        </label>
